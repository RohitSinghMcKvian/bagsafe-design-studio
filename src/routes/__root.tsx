  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <h1 className="mt-6 font-display text-7xl font-semibold text-foreground">
          404
        </h1>
        <h2 className="mt-4 text-xl font-semibold text-foreground">
          This bag took a wrong turn
        </h2>
...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "BagSafe — Avoid Excess Baggage Fees. Doorstep Luggage Delivery." },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "BagSafe — Travel Light. Save Big." },
      {
        ...
        content:
          "Doorstep luggage pickup & delivery for travelers. Avoid airline excess baggage fees with BagSafe.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@bagsafe" },
    ],
    links: [
